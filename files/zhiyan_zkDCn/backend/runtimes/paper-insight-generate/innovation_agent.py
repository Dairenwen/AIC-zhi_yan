...
from chuangx import InnovationOrchestrator, InnovationRequest
from chuangx.models import utc_now_iso
from chuangx.utils import slugify, split_list
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the chuangx innovation mining agent.")
...
def main() -> None:
    ...
    print(f"chuangx innovation agent completed: {len(top_titles)} proposal(s)")
